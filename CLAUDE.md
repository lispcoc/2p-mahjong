...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約9,639行）
- **フロントエンド**: `frontend/` — Next.js 14 + React 18 + TypeScript + Tailwind CSS 4（約5,781行）
- **テスト**: 19ファイル
...
| `frontend/components/GamePage.tsx` | 2,725 |
