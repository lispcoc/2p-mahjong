...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約8,938行）
- **フロントエンド**: `frontend/` — Next.js 14 + React 18 + TypeScript + Tailwind CSS 4（約5,428行）
- **テスト**: 19ファイル
...
| `frontend/components/HomePage.tsx` | 771 |
