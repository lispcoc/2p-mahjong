...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約10,387行）
- **フロントエンド**: `frontend/` — Next.js 14 + React 18 + TypeScript + Tailwind CSS 4（約6,965行）
- **テスト**: 20ファイル
...
| `frontend/hooks/useGameConnection.ts` | 442 |
...
| `frontend/components/GamePage.tsx` | 3,055 |
