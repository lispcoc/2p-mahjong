...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約9,648行）
- **フロントエンド**: `frontend/` — Next.js 14 + React 18 + TypeScript + Tailwind CSS 4（約5,802行）
- **テスト**: 19ファイル
...
| `frontend/components/GamePage.tsx` | 2,746 |
| `frontend/components/HomePage.tsx` | 912 |
