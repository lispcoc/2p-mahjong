...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約9,966行）
- **フロントエンド**: `frontend/` — Next.js 14 + React 18 + TypeScript + Tailwind CSS 4（約6,295行）
- **テスト**: 19ファイル
...
| `frontend/components/GamePage.tsx` | 2,907 |
| `frontend/components/HomePage.tsx` | 1,057 |
