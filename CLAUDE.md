...
- **バックエンド**: `backend/` — Node.js (Express + ws), CommonJS, ビルドステップなし（約11,072行）
...
| パス | 行数 |
|------|------|
| `frontend/types/GameTypes.ts` | 65 |
...
| `frontend/components/GamePage.tsx` | 3,107 |
